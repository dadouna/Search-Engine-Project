...
public class Indexer {
    ...
    // Create for faster relevance feedback
    /*public HashMap<Integer, HashMap<String, Integer>> docVecs = new HashMap<Integer, HashMap<String, Integer>>();
    public HashMap<String, Integer> tmp	= new HashMap<String, Integer>();
    int doc = 0;*/
